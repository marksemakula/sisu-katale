...
class QuestSdk {
    ...
    makeRequest(_a) {
        return __awaiter(this, arguments, void 0, function* ({ url, method, headers, queryParams, body, timeout }) {
            var _b, _c;
            try {
                ...
                const response = yield (0, axios_1.default)({
                    ...
                    params: queryParams,
                    headers: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ apiKey: this.apiKey }, (typeof this.userId == "string" && { userId: this.userId })), (typeof this.token === "string" && { token: this.token })), { entityId: this.entityId, ["User-Agent"]: this.userAgent, ["entity-authentication-token"]: this.entityAuthenticationToken }), (isFormData ? {} : { 'Content-Type': 'application/json' })), headers),
                    data: body,
