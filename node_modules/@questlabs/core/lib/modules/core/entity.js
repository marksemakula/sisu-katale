...
class Entity {
    ...
    createNewEntity(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ name, contracts, openseaSlug, description, chainSource = "OFF_CHAIN", isPrivate, decreaseCreditsAt, decreaseCreditsFrom, website, imageUrl, bannerUrl, entityURLAlias, parentEntityId, category, forUserId, }, options) {
            try {
    ...
    addNewCustomEntityId(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ customPlatformId, customPlatformName, entityId, accessToken, expiresIn, link, name, refreshToken, username, }, options) {
            try {
                const { userId, token } = this.questSdk.getUser();
    ...
    getAllEntities() {
        return __awaiter(this, arguments, void 0, function* ({ page, limit, category } = {}, options) {
            try {
                const url = `/entities`;
    ...
    getEntityIdForAlias(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ alias }, options) {
            try {
    ...
    getEntityIdForCustomEntityId(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ customEntityId, platform, recordType }, options) {
            try {
    ...
    updateEntity(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ entityId, name, description, isPrivate, decreaseCreditsAt, decreaseCreditsFrom, website, imageUrl, bannerUrl, entityURLAlias, }, options) {
            try {
                const { userId, token } = this.questSdk.getUser();
                const defaultEntityId = entityId || this.questSdk.getEntityId();
                (0, helperFunctions_1.validateParams)({ entityId: defaultEntityId });
    ...
    updateEntityTheme(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ theme, entityId }, options) {
            try {
                const { userId, token } = this.questSdk.getUser();
                const defaultEntityId = entityId || this.questSdk.getEntityId();
    ...
    updateEntityPlan(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ entityId, product }, options) {
            try {
                const { userId, token } = this.questSdk.getUser();
                const defaultEntityId = entityId || this.questSdk.getEntityId();
    ...
    manuallyAddUsersToEntity(_a, options_1) {
    ...
    getAllAdmins() {
        return __awaiter(this, arguments, void 0, function* ({ entityId, lessDetails } = {}, options) {
            try {
                const { userId, token } = this.questSdk.getUser();
                const defaultEntityId = entityId || this.questSdk.getEntityId();
    ...
    removeAdmin(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ userId, entityId }, options) {
            try {
    ...
    addOrUpdateSocialTokens(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ recordType, entityId, authClientId, authClientSecret, apiKey, apiSecret, authorizationToken, apiHost, }, options) {
            try {
                const { userId, token } = this.questSdk.getUser();
                const defaultEntityId = entityId || this.questSdk.getEntityId();
    ...
    getSocialTokens(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ recordType, entityId }, options) {
            try {
                const { userId, token } = this.questSdk.getUser();
                const defaultEntityId = entityId || this.questSdk.getEntityId();
                (0, helperFunctions_1.validateParams)({ entityId: defaultEntityId, recordType, userId });
    ...
    approveEntityCreation(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ baseName, baseSymbol, entityId }, options) {
            try {
                const { userId, token } = this.questSdk.getUser();
    ...
    addAdminToEntity(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ email, name, entityId, role }, options) {
            try {
                const { userId, token } = this.questSdk.getUser();
                const defaultEntityId = entityId || this.questSdk.getEntityId();
    ...
    uploadImage(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ file, entityId }, options) {
            try {
                const defaultEntityId = entityId || this.questSdk.getEntityId();
                (0, helperFunctions_1.validateParams)({ entityId: defaultEntityId });
                const url = `/upload-img`;
                const compressedFile = yield (0, helperFunctions_1.compressImageIfNeeded)(file);
                const formData = new FormData();
                formData.append("uploaded_file", compressedFile);
                if (options === null || options === void 0 ? void 0 : options._body) {
                    for (const key in options._body) {
                        const value = options._body[key];
                ...
                return this.questSdk.makeRequest({
                    ...
                    queryParams: options === null || options === void 0 ? void 0 : options._queryParams,
                    body: formData,
                    headers: Object.assign({}, ((options === null || options === void 0 ? void 0 : options._headers) || {})),
                });
            }
            catch (error) {
                this.questSdk.captureSentryException(error);
