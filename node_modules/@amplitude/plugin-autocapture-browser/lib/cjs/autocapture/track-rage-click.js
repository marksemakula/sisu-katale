...
function trackRageClicks(_a) {
    ...
    var rageClickObservable = (0, analytics_core_1.asyncMap)(clickObservable.filter(function (click) { return shouldTrackRageClick('click', click.closestTrackedAncestor); }), function (click) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var resolutionValue;
