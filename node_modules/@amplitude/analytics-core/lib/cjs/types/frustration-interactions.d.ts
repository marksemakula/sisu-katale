 ...
 */
export declare const DEFAULT_ERROR_CLICK_ALLOWLIST: string[];
/**
 ...
 */
export declare const DEFAULT_RAGE_CLICK_WINDOW_MS = 1000;
/**
 * Default threshold for rage clicks (4 clicks)
 */
export declare const DEFAULT_RAGE_CLICK_THRESHOLD = 4;
/**
 * Default threshold for rage clicks to be considered out of bounds (50 pixels)
 */
export declare const DEFAULT_RAGE_CLICK_OUT_OF_BOUNDS_THRESHOLD = 50;
