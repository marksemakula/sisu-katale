...
var AmplitudeBrowser = /** @class */ (function (_super) {
            ...
            return tslib_1.__generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        ...
                        fetchRemoteConfig = (0, config_1.shouldFetchRemoteConfig)(options);
                        loggerProvider = (_a = options.loggerProvider) !== null && _a !== void 0 ? _a : new analytics_core_1.Logger();
                        serverZone = (_b = options.serverZone) !== null && _b !== void 0 ? _b : constants_1.DEFAULT_SERVER_ZONE;
                        ...
                        remoteConfigClient = new analytics_core_1.RemoteConfigClient(options.apiKey, loggerProvider, serverZone, 
                    ...
                    case 1:
                        ...
                        _h.label = 2;
                    case 2:
                        diagnosticsClient = new analytics_core_1.DiagnosticsClient(options.apiKey, loggerProvider, serverZone, {
                        ...
                        return [4 /*yield*/, (0, config_1.useBrowserConfig)(options.apiKey, options, this, diagnosticsClient, {
                    ...
                    case 6:
                        ...
                        if (!(0, default_tracking_1.isAttributionTrackingEnabled)(this.config.defaultTracking)) return [3 /*break*/, 8];
                        if (this.config.optOut) {
                            this.timeline.addOptOutListener(function (optOut) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var attributionTrackingOptions_1;
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if (!!optOut) return [3 /*break*/, 2];
                                            attributionTrackingOptions_1 = (0, default_tracking_1.getAttributionTrackingConfig)(this.config);
                                            this.webAttribution = new web_attribution_1.WebAttribution(attributionTrackingOptions_1, this.config);
                    ...
                    case 8:
                        ...
                        this.setSessionId((_g = (_f = (_e = options.sessionId) !== null && _e !== void 0 ? _e : querySessionId) !== null && _f !== void 0 ? _f : deferredSessionId) !== null && _g !== void 0 ? _g : this.config.sessionId);
                        if (this.config.optOut) {
                            this.timeline.addOptOutListener(function (optOut) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                return tslib_1.__generator(this, function (_a) {
                        ...
                        if (!(this.config.offline !== analytics_core_1.OfflineDisabled)) return [3 /*break*/, 10];
                        return [4 /*yield*/, this.add((0, network_connectivity_checker_1.networkConnectivityCheckerPlugin)()).promise];
                    case 9:
                        _h.sent();
                        _h.label = 10;
                    case 10: return [4 /*yield*/, this.add(new analytics_core_1.Destination({ diagnosticsClient: diagnosticsClient })).promise];
                    case 11:
                        _h.sent();
                    ...
                    case 13:
                        ...
                        if (!(0, default_tracking_1.isFileDownloadTrackingEnabled)(this.config.defaultTracking)) return [3 /*break*/, 15];
                    ...
                    case 14:
                        ...
                        _h.label = 15;
                    case 15:
                        if (!(0, default_tracking_1.isFormInteractionTrackingEnabled)(this.config.defaultTracking)) return [3 /*break*/, 17];
                    ...
                    case 16:
                        ...
                        _h.label = 17;
                    case 17:
                        if (!(0, default_tracking_1.isPageViewTrackingEnabled)(this.config.defaultTracking)) return [3 /*break*/, 20];
                    ...
                    case 19:
                        ...
                        _h.label = 20;
                    case 20:
                        if (!(0, default_tracking_1.isElementInteractionsEnabled)(this.config.autocapture)) return [3 /*break*/, 22];
                    ...
                    case 21:
                        ...
                        _h.label = 22;
                    case 22:
                        if (!(0, default_tracking_1.isFrustrationInteractionsEnabled)(this.config.autocapture)) return [3 /*break*/, 24];
                    ...
                    case 23:
                        ...
                        _h.label = 24;
                    case 24:
                        if (!(0, default_tracking_1.isNetworkTrackingEnabled)(this.config.autocapture)) return [3 /*break*/, 26];
                    ...
                    case 25:
                        ...
                        _h.label = 26;
                    case 26:
                        if (!(0, default_tracking_1.isWebVitalsEnabled)(this.config.autocapture)) return [3 /*break*/, 28];
                    ...
                    case 27:
                        ...
                        _h.label = 28;
                    case 28:
                        if (!(0, default_tracking_1.isPageUrlEnrichmentEnabled)(this.config.autocapture)) return [3 /*break*/, 30];
    ...
    AmplitudeBrowser.prototype.setIdentity = function (identity) {
        ...
        if ('userProperties' in identity) {
            ...
            var identifyObj = new analytics_core_1.Identify();
            // istanbul ignore next
            var userProperties = (_b = identity.userProperties) !== null && _b !== void 0 ? _b : {};
            try {
                for (var _c = tslib_1.__values(Object.entries(userProperties)), _d = _c.next(); !_d.done; _d = _c.next()) {
    ...
    AmplitudeBrowser.prototype.logBrowserOptions = function (browserConfig) {
        try {
            ...
            this.config.loggerProvider.debug('Initialized Amplitude with BrowserConfig:', (0, analytics_core_1.safeJsonStringify)(browserConfigCopy));
        }
        catch (e) {
            /* istanbul ignore next */
