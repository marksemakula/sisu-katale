...
export declare class BrowserConfig extends Config implements IBrowserConfig {
    ...
    get deferredSessionId(): number | undefined;
...
export declare const createTransport: (transport?: TransportTypeOrOptions) => FetchTransport | XHRTransport | SendBeaconTransport;
